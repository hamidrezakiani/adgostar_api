...
use App\Services\Executer\ExecuterService;
use Illuminate\Http\Request;

class ExecuterController extends Controller
{

    protected $executerService;

    public function __construct(ExecuterService $executerService)
    {
    ...
    {
        return $this->executerService->find();
    }
